...
<p>{!! link_to_route(config('quickadmin.route').'.doctorassistant.create', trans('quickadmin::templates.templates-view_index-add_new') , null, array('class' => 'btn btn-success')) !!}</p>
...
<td>{{ $row->doctor_id }}</td>
            ...
            {!! Form::open(['route' => config('quickadmin.route').'.doctorassistant.massDelete', 'method' => 'post', 'id' => 'massDelete']) !!}
