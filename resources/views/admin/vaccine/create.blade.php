...
{!! Form::open(array('route' => config('quickadmin.route').'.vaccine.store', 'id' => 'form-with-validation', 'class' => 'form-horizontal')) !!}
...
<div class="form-group">
    ...
    <div class="col-sm-10">
        {!! Form::text('repeat', old('repeat'), array('class'=>'form-control')) !!}
        
    </div>
</div><div class="form-group">
    {!! Form::label('starts', 'Starts At*', array('class'=>'col-sm-2 control-label')) !!}
    <div class="col-sm-10">
        {!! Form::text('starts', old('starts'), array('class'=>'form-control')) !!}
