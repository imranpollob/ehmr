...
@section('content')
    ...
    {!! Form::open(array('files' => true, 'route' => config('quickadmin.route').'.testeditor.store', 'id' => 'form-with-validation', 'class' => 'form-horizontal')) !!}

    <div class="form-group">
        {!! Form::label('editor', 'editor', array('class'=>'col-sm-2 control-label')) !!}
        <div class="col-sm-10">
            {!! Form::textarea('editor', old('editor'), array('class'=>'form-control ckeditor')) !!}
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10 col-sm-offset-2">
            <select data-placeholder="Choose a Country..." multiple class="chosen form-control">
                <option value=""></option>
