...
<p>{!! link_to_route(config('quickadmin.route').'.prescription.create', trans('quickadmin::templates.templates-view_index-add_new') , null, array('class' => 'btn btn-success')) !!}</p>
