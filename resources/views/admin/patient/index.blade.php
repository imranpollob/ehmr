...
@section('content')
    ...
    @if ($patient->count())
        ...
        <div class="text-md-center">{!! link_to_route(config('quickadmin.route').'.patient.create', trans('quickadmin::templates.templates-view_index-add_new') , null, array('class' => 'btn btn-default')) !!}</div>
