...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            <h4 class="card-title">Add New Hospital Assistant</h4>
        ...
        <div class="card-block">
            {!! Form::open(array('route' => config('quickadmin.route').'.hospitalassistant.store', 'id' => 'form-with-validation', 'class' => 'form-horizontal')) !!}
