...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            <h4 class="card-title">Add New Lab Assistant</h4>
        ...
        <div class="card-block">
            ...
            {!! Form::open(array('route' => config('quickadmin.route').'.labassistant.store', 'id' => 'form-with-validation', 'class' => 'form-horizontal')) !!}
            ...
            <div class="row form-group">
                ...
                <div class="col-sm-10">
                    {!! Form::select('lab_id', $lab, old('lab_id'),
                    array('class'=>'form-control chosen', 'placeholder'=>'Please Select')) !!}
