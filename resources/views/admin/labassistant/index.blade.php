...
<p>{!! link_to_route(config('quickadmin.route').'.labassistant.create', trans('quickadmin::templates.templates-view_index-add_new') , null, array('class' => 'btn btn-success')) !!}</p>
...
<td>{{ $row->lab_id }}</td>
            ...
            {!! Form::open(['route' => config('quickadmin.route').'.labassistant.massDelete', 'method' => 'post', 'id' => 'massDelete']) !!}
