...
<p>{!! link_to_route(config('quickadmin.route').'.diagnosis.create', trans('quickadmin::templates.templates-view_index-add_new') , null, array('class' => 'btn btn-success')) !!}</p>
...
<td>{{ $row->recommended_for }}</td>
            ...
            {!! Form::open(['route' => config('quickadmin.route').'.diagnosis.massDelete', 'method' => 'post', 'id' => 'massDelete']) !!}
