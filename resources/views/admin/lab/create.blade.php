...
{!! Form::open(array('route' => config('quickadmin.route').'.lab.store', 'id' => 'form-with-validation', 'class' => 'form-horizontal')) !!}
...
<div class="form-group">
    ...
    <div class="col-sm-10">
        {!! Form::select('lab_type', $lab_type, old('lab_type'), array('class'=>'form-control')) !!}
