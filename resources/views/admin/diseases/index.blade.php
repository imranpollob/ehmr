...
<p>{!! link_to_route(config('quickadmin.route').'.diseases.create', trans('quickadmin::templates.templates-view_index-add_new') , null, array('class' => 'btn btn-success')) !!}</p>
...
@if ($diseases->count())
    <div class="portlet box green">
        ...
        <div class="portlet-body">
            ...
            {!! Form::open(['route' => config('quickadmin.route').'.diseases.massDelete', 'method' => 'post', 'id' => 'massDelete']) !!}
